...
enum DemoData {
    static func defaultCategories() -> [LedgerCategory] {
        ...
        let expense: [(String, String, String, [(String, String)])] = [
            ("餐饮", "fork.knife", "#EF6C5B", [("早餐", ""), ("午餐", ""), ("晚餐", ""), ("夜宵", ""), ("外卖", ""), ("咖啡茶饮", ""), ("零食水果", ""), ("聚餐", ""), ("食堂", ""), ("买菜食材", ""), ("烘焙甜品", ""), ("酒水饮料", ""), ("自助餐", ""), ("其他餐饮", "")]),
            ("交通出行", "car.fill", "#4F8EF7", [("公交地铁", ""), ("打车", ""), ("网约车", ""), ("共享单车", ""), ("加油", ""), ("充电", ""), ("停车费", ""), ("高速路桥", ""), ("车辆保养", ""), ("违章罚款", ""), ("代驾", ""), ("机票", ""), ("火车票", ""), ("船票", "")]),
            ("居住", "house.fill", "#68B984", [("房租", ""), ("水费", ""), ("电费", ""), ("燃气", ""), ("物业", ""), ("宽带", ""), ("手机话费", ""), ("家居维修", ""), ("清洁用品", ""), ("搬家", ""), ("取暖", ""), ("房屋保险", ""), ("家政服务", "")]),
            ("购物", "bag.fill", "#F5A623", [("日用百货", ""), ("生鲜食品", ""), ("服饰鞋包", ""), ("数码电器", ""), ("美妆护肤", ""), ("母婴用品", ""), ("宠物用品", ""), ("家具家电", ""), ("办公用品", ""), ("首饰配饰", ""), ("礼品", "")]),
            ("医疗健康", "cross.case.fill", "#E85D75", [("门诊", ""), ("住院", ""), ("药品", ""), ("体检", ""), ("牙科", ""), ("眼科", ""), ("疫苗", ""), ("心理咨询", ""), ("运动健身", ""), ("保健", ""), ("保险", "")]),
            ("教育学习", "graduationcap.fill", "#8167D9", [("书籍", ""), ("文具", ""), ("课程", ""), ("培训", ""), ("学费", ""), ("考试报名", ""), ("语言学习", ""), ("学习工具", ""), ("云服务", ""), ("会员订阅", "")]),
            ("休闲娱乐", "gamecontroller.fill", "#C16CE6", [("电影演出", ""), ("游戏", ""), ("KTV", ""), ("旅行", ""), ("酒店住宿", ""), ("摄影", ""), ("兴趣爱好", ""), ("线上娱乐", ""), ("运动场馆", ""), ("景点门票", ""), ("乐器玩具", "")]),
            ("人情往来", "gift.fill", "#E977A6", [("红包", ""), ("礼金", ""), ("婚礼随礼", ""), ("请客送礼", ""), ("孝敬父母", ""), ("朋友聚会", ""), ("慈善捐赠", "")]),
            ("金融支出", "creditcard.fill", "#607D8B", [("信用卡还款", ""), ("贷款还款", ""), ("利息", ""), ("手续费", ""), ("税费", ""), ("转账", ""), ("汇率损失", "")]),
            ("其他支出", "ellipsis.circle.fill", "#8B95A1", [("罚款", ""), ("捐赠", ""), ("未分类", "")])
        ]
        let income: [(String, String, String, [(String, String)])] = [
            ("工资收入", "banknote.fill", "#3AAE6D", [("基本工资", ""), ("奖金", ""), ("补贴", ""), ("报销", ""), ("加班费", ""), ("年终奖", "")]),
    ...
    static let supplementalDefaultSubcategories: [String: [String]] = [
        "餐饮": ["买菜食材", "烘焙甜品", "酒水饮料", "自助餐", "其他餐饮"],
        "交通出行": ["网约车", "充电", "车辆保养", "违章罚款", "代驾", "船票"],
        "居住": ["搬家", "取暖", "房屋保险", "家政服务"],
        "购物": ["生鲜食品", "办公用品", "首饰配饰"],
        "医疗健康": ["住院", "眼科", "疫苗", "心理咨询"],
        "教育学习": ["文具", "学费", "语言学习", "云服务"],
