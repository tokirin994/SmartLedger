...
enum DemoData {
    ...
    static func categoryIcon(for name: String, fallback: String) -> String {
        let icons: [String: String] = [
            ...
            "打车": "car.side.fill", "网约车": "car.side", "公交地铁": "tram.fill", "地铁公交": "tram", "加油": "fuelpump.fill", "充电": "bolt.car.fill", "加油停车": "fuelpump", "停车费": "parkingsign.circle.fill", "高速路桥": "road.lanes", "火车票": "train.side.front.car", "机票": "airplane", "火车机票": "airplane.departure", "船票": "ferry.fill", "共享单车": "bicycle", "代驾": "steeringwheel", "租车": "car.circle", "车辆保养": "wrench.and.screwdriver.fill", "洗车": "car.fill", "违章罚款": "exclamationmark.triangle.fill",
            "房租": "building.2.fill", "水电网": "bolt.fill", "水费": "drop.fill", "电费": "bolt.fill", "燃气": "flame.fill", "物业": "building.2", "宽带": "wifi", "手机话费": "phone.fill", "家居用品": "bed.double.fill", "家居维修": "wrench.and.screwdriver", "家电维修": "wrench.and.screwdriver", "清洁用品": "sparkles", "搬家": "box.truck.fill", "取暖": "thermometer.sun.fill", "房屋保险": "house.and.flag.fill", "家政服务": "person.badge.clock.fill", "家具家电": "sofa.fill", "装修": "hammer.fill", "绿植花卉": "leaf.fill",
            "日用品": "cart.fill", "日用百货": "cart.fill", "生鲜食品": "fish.fill", "服饰": "tshirt.fill", "服饰鞋包": "tshirt", "数码": "iphone", "数码电器": "iphone", "美妆护肤": "face.smiling", "母婴用品": "figure.and.child.holdinghands", "宠物用品": "pawprint.fill", "办公用品": "pencil.and.list.clipboard", "首饰配饰": "diamond.fill", "图书杂志": "books.vertical.fill", "快递运费": "shippingbox.fill", "礼品": "gift.fill",
            "门诊": "stethoscope", "住院": "bed.double.fill", "药品": "pills.fill", "体检": "heart.text.square.fill", "牙科": "mouth.fill", "眼科": "eye.fill", "疫苗": "syringe.fill", "心理咨询": "brain.head.profile", "保健": "heart.circle.fill", "医疗器械": "cross.case.fill", "保险": "shield.fill",
            "书籍": "books.vertical.fill", "书籍资料": "books.vertical", "文具": "pencil.tip", "课程": "graduationcap.fill", "课程培训": "graduationcap", "学费": "banknote.fill", "考试报名": "checklist", "语言学习": "character.book.closed.fill", "学习工具": "laptopcomputer", "云服务": "cloud.fill", "软件订阅": "rectangle.and.pencil.and.ellipsis", "会员订阅": "person.crop.circle.badge.checkmark",
            "电影演出": "popcorn.fill", "游戏": "gamecontroller.fill", "旅行": "airplane", "酒店住宿": "bed.double.fill", "摄影": "camera.fill", "兴趣爱好": "paintpalette.fill", "线上娱乐": "play.tv.fill", "运动场馆": "figure.run", "景点门票": "ticket.fill", "乐器玩具": "music.note", "宠物娱乐": "pawprint.fill", "休闲玩乐": "party.popper.fill", "运动健身": "figure.run", "KTV": "music.mic",
            "红包": "envelope.open.fill", "礼物": "gift.fill", "请客": "person.2.fill", "礼金": "giftcard.fill", "婚礼随礼": "heart.fill", "探望慰问": "heart.text.square", "慈善捐赠": "hands.sparkles.fill",
            "信用卡还款": "creditcard.fill", "贷款还款": "building.columns.fill", "利息": "percent", "手续费": "receipt.fill", "税费": "building.columns", "转账": "arrow.left.arrow.right", "汇率损失": "globe", "投资亏损": "chart.line.downtrend.xyaxis", "罚款": "exclamationmark.circle.fill", "捐赠": "heart.fill", "订阅服务": "repeat.circle.fill", "未分类": "square.grid.2x2",
            "基本工资": "wallet.pass.fill", "工资": "wallet.pass", "奖金": "star.square.fill", "补贴": "plus.circle.fill", "报销": "doc.text.fill", "加班费": "clock.badge.checkmark.fill", "年终奖": "sparkles", "退款入账": "arrow.uturn.backward.circle.fill", "转账收入": "arrow.down.left.circle.fill", "销售": "cart.fill", "服务收入": "person.badge.plus", "佣金": "percent", "稿费": "pencil.and.outline", "版权收入": "c.circle.fill", "理财收益": "chart.line.uptrend.xyaxis", "股息": "banknote.fill", "基金收益": "chart.pie.fill", "股票收益": "chart.bar.fill", "利息收入": "percent", "退款": "arrow.uturn.backward.circle.fill", "礼金红包": "envelope.open.fill", "二手出售": "arrow.2.squarepath", "兼职": "briefcase.fill", "租金收入": "house.fill", "意外所得": "gift.fill"
        ]
